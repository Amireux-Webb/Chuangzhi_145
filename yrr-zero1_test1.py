...
class LLMTrainer:
    def __init__(self, args):
        ...
        # 获取当前脚本所在的目录
        base_path = Path(__file__).parent.resolve()  # 获取绝对路径

        # 使用绝对路径打开 params.json 文件
        params_path = base_path / args.ckpt_dir / "params.json"
        ...
        checkpoint_path = base_path / args.ckpt_dir / "llm.pth"
    ...
    def save_checkpoint(self, epoch_idx):
        ...
        torch.save(to_save, f"./finetuned_llm_{epoch_idx}.pth")
